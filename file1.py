...
class Data(db.Model):
    ...
    semester1 = db.Column(db.String(100))
    semester2 = db.Column(db.String(100))
    semester3 = db.Column(db.String(100))
    semester4 = db.Column(db.String(100))
    semester5 = db.Column(db.String(100))
    semester6 = db.Column(db.String(100))
    semester7 = db.Column(db.String(100))
    semester8 = db.Column(db.String(100))
...
def students():
    ...
    if request.method == 'POST' and 'tag' in request.form:
        ...
        search = "%{}%".format(tag)
        students = Data.query.filter(Data.name.like(search)).paginate(page=page, per_page=ROWS_PER_PAGE,error_out=False)  
